...
module testbench_task1;
  ...
  // Goal: Create two signals, 'signal_a' and 'signal_b', that change based on two  different clocks ('clk1' and 'clk2'). - 'signal_a' changes based on 'clk1'.  - 'signal_b' changes based on 'signal_a' AND 'clk2'. 
  task gen_case7;
      ...
      fork
        ...
        begin
          forever begin
            ...
            @(posedge clk2_c8 iff signal_a_c8 == 1);
  ...
  begin
    fork
      ...
      // Thread 2: The Toggler (for signal_b), now using 'wait'
      begin
        forever begin
          wait (signal_a_c10 == 7); // Wait until signal_a_c10 becomes 7
          // Once we’re in the 7-phase (4 cycles), toggle every clock
          repeat (4) begin
            @(posedge clk_c3);
